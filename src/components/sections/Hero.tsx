...
Indian Institute of Science Bangalore</p>
            <p className="text-muted-foreground mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">I'm a PhD student working in the broad areas of stochastic control, networked control systems, and reinforcement learning. My research focuses on designing optimal scheduling policies for  resource constrained and networked systems. I am advised by Prof. Shalabh Bhatnagar, and my work combines theoretical analysis with algorithmic design, motivated by problems arising in communication networks and control systems.</p>
